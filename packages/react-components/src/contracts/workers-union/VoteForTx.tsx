...
import { DecodedTxData, handleTransaction, TxStatus } from "@workhard/react-utils";
import { DecodedTxs } from "../../views/DecodedTxs";
...
export const VoteForTx: React.FC<VoteForTxProps> = ({
  ...
  useEffect(() => {
    if (!workhard || !library || !blockNumber) {
      return;
    }
    const { workersUnion, timelock } = workhard.dao;
