...
export const EmissionChart: React.FC<EmissionChartProps> = ({
  ...
  const secondary = color?.secondary || defaultSecondary;
          ...
          >
            <defs>
              <linearGradient id="colorEmission" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="95%" stopColor={primary} stopOpacity={0.3} />
              </linearGradient>
              <linearGradient id="colorSupply" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor={secondary} stopOpacity={0.8} />
                <stop offset="95%" stopColor={secondary} stopOpacity={0.3} />
              </linearGradient>
            </defs>
