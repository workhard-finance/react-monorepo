...
import { CreateLock, MyLock, Distribute } from "@workhard/react-components";
...
export const EscrowAndDividend: React.FC = () => {
  ...
  useEffect(() => {
    if (!!account && !!workhard && !!account) {
      const { votingEscrow } = workhard.dao;
