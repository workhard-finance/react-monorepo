...
import { VoteForTx, ProposedTx, VoteForTxStatus } from "@workhard/react-components";
import { useWeb3React } from "@web3-react/core";
import { useWorkhard, useBlockNumber } from "@workhard/react-core";
import { BigNumber, providers } from "ethers";
import { altWhenEmptyList } from "@workhard/react-utils";
...
const Vote: React.FC = () => {
  ...
  }, [library, chainId, blockNumber, workhard]);

  useEffect(() => {
    if (!account || !library || !chainId || !workhard) {
      return;
    }
    workhard.dao.voteCounter
      .balanceOf(account)
      .then((vote) => {
        setMyVotes(vote);
      })
  ...
  }, [account, library, chainId, blockNumber, workhard]);
        ...
        <Col sm={9}>
          <Tab.Content>
            ...
            >
              ...
              <h5>
                <strong>
                  How much {workhard?.metadata.rightSymbol || `$RIGHT`} do I
                  need to start a new vote?
                </strong>
              </h5>
              <p>
                You should have more than 1{" "}
                {workhard?.metadata.rightSymbol || `$RIGHT`} to start a vote.
              ...
              <p>
                ...
                {workhard?.metadata.rightSymbol || `$RIGHT`} for its quorum.
              </p>
              <h5>
