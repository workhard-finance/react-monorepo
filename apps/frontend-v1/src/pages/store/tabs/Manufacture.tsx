...
import { ConditionalButton, ProductView } from "@workhard/react-components";
import { permaPinToArweave } from "@workhard/react-utils";
...
export const Manufacture: React.FC = () => {
  ...
  function submitTx() {
    ...
    const marketplace = workhard.dao.marketplace;
    if (!marketplace) {
      alert("Not connected");
      return;
    }
          ...
          <Card>
            <Card.Body>
              <Form>
                ...
                <Form.Group>
                  <Form.Label>
                    Price (in {workhard?.metadata.commitSymbol || `$COMMIT`})
                  </Form.Label>
                  <Form.Control
                    type="number"
